...
A single skill (`designer`) that orchestrates the Stitch design workflow. Five phases:
...
- **Phase 3: Page Design** — Generate individual pages referencing established layouts and design tokens
...
Every generation runs through a 6-step **Prompt Enhancement Pipeline** that applies terminology refinement, Refactoring UI design principles, and Gemini optimization rules before calling Stitch.
